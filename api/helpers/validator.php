...
class Validator
{
    ...
    {
        // Se verifica el contenido y la longitud de acuerdo con la base de datos, incluyendo el signo "+".
    ...
    /*
    /*
     *   Método para validar un enlace de internet.
     *   Parámetros: $value (dato a validar).
     *   Retorno: booleano (true si el valor es correcto o false en caso contrario).
     */
    public static function validateLink($value)
    {
        // Se verifica si es un enlace válido.
